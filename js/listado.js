...
Listado.prototype.obtenerCiudadesSinRepetir = function() {
    ...
    ciudadesRepetidas = this.restaurantes.map(function(restaurante) {
        return restaurante.ubicacion
    });
    //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
    var ciudadesSinRepetirse = eliminarRepetidos(ciudadesRepetidas);
...
Listado.prototype.obtenerRubrosSinRepetir = function() {
    ...
    var rubrosSinRepetir = eliminarRepetidos(rubrosRepetidos);
...
function eliminarRepetidos(arreglo) {
    return arreglo.filter(function(elem, index, self) {
